...
# This file uses MLBAM data from 2021 to predict sequences of pitch types 
# A deep learning architecture known as an encoder-decoder will be used to that end 
